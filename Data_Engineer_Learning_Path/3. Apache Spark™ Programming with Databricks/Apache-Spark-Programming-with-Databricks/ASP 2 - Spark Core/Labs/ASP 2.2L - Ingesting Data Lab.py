...
spark.conf.set("databricks_academy.product_path", products_csv_path)

# COMMAND ----------

# MAGIC %scala
# MAGIC 
# MAGIC val productsCsvPath = spark.conf.get("databricks_academy.product_path")
# MAGIC 
# MAGIC val productSchema = spark
# MAGIC   .read
# MAGIC   .option("inferSchema", true)
# MAGIC   .option("header", true)
# MAGIC   .csv(productsCsvPath)
# MAGIC   .schema
# MAGIC   .toDDL
# MAGIC 
# MAGIC println("="*80)
# MAGIC println(productSchema)
# MAGIC println("="*80)
