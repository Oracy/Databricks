...
# MAGIC %fs ls dbfs:/user/ext.oracy.martos@farfetch.com/dbacademy/aspwd/datasets
...
# TODO
# files = dbutils.fs.ls('wasbs/courseware@dbacademy.blob.core.windows.net/apache-spark-programming-with-databricks/v02/')
files = dbutils.fs.ls('dbfs:/user/ext.oracy.martos@farfetch.com/dbacademy/aspwd/datasets')
display(files)
...
# MAGIC %sql
# MAGIC SELECT round(avg(purchase_revenue_in_usd), 2) FROM sales;
